    ...
    export class Canvas extends DrawingEngine
    {
        ...
        public draw(nodeElement: NodeElement): void
        {
            ...
            let xOffset: number = this.viewPort.getX();
            let yOffset: number = this.viewPort.getY();

            let width: number  = this.viewPort.getWidth();
            let height: number = this.viewPort.getHeight();
        ...
        private drawInfo(): void
        {
            ...
            let xSize = this.viewPort.getWidth();
            let ySize = this.viewPort.getHeight();
